class_name ScreenModDactylographyGame
extends Node
...
func refresh() -> void:
	...
	ScreenBuilderPrint6x8.print_text_6x8_at_lrtd(array, Vector2i(2,46),str(score),true,true)
	ScreenBuilderPrint6x8.print_text_6x8_at_lrtd(array, Vector2i(64,46),str(mistakes),true,true)
	screen.set_value_with_1d_array_and_draw(array)
